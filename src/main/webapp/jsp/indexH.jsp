...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/h/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/static/h/img/profile_small.jpg" /></span>
                    ...
                    <c:forEach items="${menus}" var="menus">
                        <li>
                            <a href="#">
                                ...
                                <span class="nav-label">${menus.name}</span>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${pageContext.request.contextPath}/welcome" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
    ...
    <!-- 自定义js -->
    <script src="${pageContext.request.contextPath}/static/h/js/hplus.js?v=4.1.0"></script>
